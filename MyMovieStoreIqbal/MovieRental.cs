using MyMovieStoreIqbal.Common;
using MyMovieStoreIqbal.DatabaseQueries;
using MyMovieStoreIqbal.Operation;
using System;
using System.Data;
...
namespace MyMovieStoreIqbal
{
    public partial class MovieRental : Form
    {
        ...
        // Here I do the customer add code
        private void AddCustomer_Click(object sender, EventArgs e)
        {
            try
            {
                // When we select the customer tab the add customer works
